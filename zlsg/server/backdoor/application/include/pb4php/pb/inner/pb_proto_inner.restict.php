...
class getPlayerRestictList_req extends \PBMessage
{
  ...
  public function __construct($reader=null)
  {
    ...
    self::$fields["getPlayerRestictList_req"]["1000"] = "inner\\inner_head";
    $this->values["1000"] = "";
...
class ban_info extends \PBMessage
{
  ...
  {
    parent::__construct($reader);
    self::$fields["ban_info"]["1"] = "inner\\inner_user";
    $this->values["1"] = "";
...
class getPlayerRestictList_rsp extends \PBMessage
{
  ...
  {
    parent::__construct($reader);
    self::$fields["getPlayerRestictList_rsp"]["1"] = "inner\\ban_info";
    $this->values["1"] = array();
    self::$fieldNames["getPlayerRestictList_rsp"]["1"] = "bi";
    self::$fields["getPlayerRestictList_rsp"]["1000"] = "inner\\inner_tail";
    $this->values["1000"] = "";
...
class addPlayerRestict_req extends \PBMessage
{
  ...
  {
    parent::__construct($reader);
    self::$fields["addPlayerRestict_req"]["1"] = "inner\\ban_info";
    $this->values["1"] = array();
    self::$fieldNames["addPlayerRestict_req"]["1"] = "bi";
    self::$fields["addPlayerRestict_req"]["1000"] = "inner\\inner_head";
    $this->values["1000"] = "";
...
class addPlayerRestict_rsp extends \PBMessage
{
  ...
  {
    parent::__construct($reader);
    self::$fields["addPlayerRestict_rsp"]["1000"] = "inner\\inner_tail";
    $this->values["1000"] = "";
...
class delPlayerRestict_req extends \PBMessage
{
  ...
  {
    parent::__construct($reader);
    self::$fields["delPlayerRestict_req"]["1"] = "inner\\ban_info";
    $this->values["1"] = array();
    self::$fieldNames["delPlayerRestict_req"]["1"] = "bi";
    self::$fields["delPlayerRestict_req"]["1000"] = "inner\\inner_head";
    $this->values["1000"] = "";
...
class delPlayerRestict_rsp extends \PBMessage
{
  ...
  {
    parent::__construct($reader);
    self::$fields["delPlayerRestict_rsp"]["1000"] = "inner\\inner_tail";
    $this->values["1000"] = "";
