 ...
 */  
void _base64_encode_triple(const unsigned char triple[3], char result[4])
{
    int tripleValue, i;
 ...
 */  
int _base64_decode_triple(unsigned char quadruple[4], unsigned char *result)
 {
...
int base64_decode(const char *source, unsigned char *target, size_t targetlen)
 {
    char *src, *tmpptr;
    unsigned char quadruple[4], tmpresult[3];
    size_t tmplen = 3;
    size_t converted = 0;
