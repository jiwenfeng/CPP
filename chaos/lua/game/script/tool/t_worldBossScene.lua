function ParseTable(table)
	...
	for line, Data in ipairs(table[1]) do --只读第一页
		...
		if line > 1 then
			...
			if Data[57] and Data[58] then
				CodeString = CodeString .. string.format("\t\tsealBarX = %d,\n\t\tsealBarY = %d,\n", Data[57], Data[58])
			end
...
function gen()
	local excelfile = "table/worldBossScene.xls"
	local outfile = "autocode/worldBossScene.lua"
